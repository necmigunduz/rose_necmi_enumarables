...
describe Enumerable do
    ...
    describe '#my_select' do
        ...
        it 'returns the select items in a hash' do
            expect(hash.my_select {|item,key| key == 3}).to eql([[:c,3]])
        end
    ...
    describe '#my_all?' do
        ...
        it 'returns a boolean' do
            expect(hash.my_all? {|item,key| item == :a}).to be false 
        end
    ...
    describe '#my_any?' do
        ...
        it 'returns a boolean' do
            expect(hash.my_any? {|item,key| key == 3 }).to be true
        end
    ...
    describe '#my_none?' do
        ...
        it 'returns a boolean' do
            expect(hash.my_none? {|item,key| key == 2}).to be true
        end
